class Form{
    ...
    this.question1 = createElement("h2","Hello! What Is Your name?")
    ...
    this.question2 = createElement("h2","Do you think we need to have free lunch meals in our school canteen for the kids who are very poor and need help?")
    ...
    this.question4 = createElement("h2","How much per month would you be willing to pay? (in rupees) ")
    this.radio3 = createRadio();
    this.radio3.option("100");
    this.radio3.option("500");
    this.radio3.option("1000");
    this.radio3.option("More than 1000")
